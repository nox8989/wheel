jQuery(document).ready(function ($) {
    ...
    $('#gdpr_policy,#wlwl_enable_funnelkit,#wlwl_enable_sendy,#wlwl_enable_mailster,#wlwl_enable_mailpoet,#mailchimp_enable, #wlwl_enable_active_campaign, #wlwl_sendgrid_enable, #wlwl_enable_sendinblue, #wlwl_enable_klaviyo,#wlwl_enable_hubspot, #metrilo_enable').on('change', function () {
...
jQuery(document).ready(function ($) {
    ...
    addImgLink1.on('click', function (event) {
        ...
        frame1.on('select', function () {
            ...
            var attachment_url1;
            if (attachment1?.sizes?.thumbnail?.url) {
            ...
            }else if (attachment1?.sizes?.full?.url) {
            ...
            if (attachment_url1) {
                // Send the attachment URL to our custom image input field.
                imgContainer1.append('<div class="wlwl-image-container1"><img style="border: 1px solid;max-width: 300px;"class="review-images" src="' + attachment_url1 + '"/><input class="wheel_center_image" name="wheel_center_image" type="hidden" value="' + attachment1.id + '"/><span class="wlwl-remove-image1 nagative vi-ui button">Remove</span></div>');
    ...
    $(document).on('click','.wlwl-remove-image1', function (event) {
        event.preventDefault();
        $(this).parent().html('');
